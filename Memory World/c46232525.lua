...
function s.spfilter(c,e,tp,mc)
	...
	return c:IsType(TYPE_FUSION) and aux.IsMaterialListCode(c,84565800) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_FUSION,tp,false,false) and
		(#mustg==0 or (#mustg==1 and mustg:IsContains(c:GetCode()))) and aux.IsMaterialListRace(c,mc:GetRace())
end
