...
function s.atcon(e)
	return Duel.IsExistingMatchingCard(s.swapfilter,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil)
end
...
function s.filter(c,e,tp)
	return c:IsType(TYPE_NORMAL) and c:IsType(TYPE_MONSTER) and c:IsLevelBelow(3) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
