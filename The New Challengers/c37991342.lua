...
function s.initial_effect(c)
	...
	eUnionSummon:SetTarget(aux.ExtraNormalTarget(true,false,TYPE_UNION,0,0,0,0))
	eUnionSummon:SetOperation(aux.ExtraNormalOperation(true,false,TYPE_UNION,0,0,0,0))
...
function s.filter(c)
	return c:IsSetCard(0xaa) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end
