...
s.fit_monster={97642679}
function s.filter(c,e,tp,m)
	local cd=c:GetCode()
	if cd~=97642679 or not c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_RITUAL,tp,true,true) then return false end
