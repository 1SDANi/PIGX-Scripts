...
function s.cfilter(c)
	return c:IsSetCard(0x26) and c:IsType(TYPE_MONSTER) and not c:IsCode(id)
end
...
function s.filter(c,e,tp)
	return c:IsSetCard(0x26) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
