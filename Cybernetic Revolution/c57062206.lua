...
function s.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SendtoHand(e:GetHandler(),REASON_COST)
end
function s.filter(c,e,tp)
	return c:IsCode(60246171) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.filter(c)
	return c:IsFaceup() and c:IsCode(60246171)
end
