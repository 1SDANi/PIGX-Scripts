...
function s.val(e,c)
	return Duel.GetMatchingGroupCount(aux.FilterFaceupFunction(Card.IsRace,RACE_MACHINE),0,LOCATION_MZONE,0,e:GetHandler())*500
end
function s.filter(c)
	return c:IsSetCard(0xab) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
