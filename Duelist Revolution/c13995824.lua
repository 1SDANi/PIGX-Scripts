...
function s.filter(c,e,tp)
	...
	return c:IsCode(77506119) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_FUSION,tp,false,false)
end
...
function s.fusionfilter(c,fc,sumtype,sp,sub,mg,sg)
	...
	return c:IsRace(RACE_BEAST) and c:IsLevelAbove(1) and (not rg or not sg or (st==tg and #sg>1) or (st<tg and rg:CheckWithSumEqual(Card.GetLevel,tg-st,1,99)))
end
