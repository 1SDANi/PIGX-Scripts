...
function s.filter(c,e,tp)
	return c:IsFaceup() and c:IsRace(RACE_BEAST) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g and #g> and tc and tc:IsRelateToEffect(e) and Duel.Remove(g,POS_FACEUP,REASON_EFFECT)>0 then
