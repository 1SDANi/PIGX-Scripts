...
function s.filter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsSetCard(0x10) and (c:IsCanBeSpecialSummoned(e,0,tp,false,false) or c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP,1-tp))
end
