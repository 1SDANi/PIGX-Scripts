...
s.listed_names={47826112}
function s.filter(c,e,tp)
	return c:IsAttribute(ATTRIBUTE_WATER) and c:IsCanBeSpecialSummoned(e,155,tp,false,false)
end
...
function s.tgfilter(c)
	return c:IsCode(47826112) and c:IsAbleToGrave()
end
