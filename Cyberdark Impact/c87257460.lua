...
function s.eqval(ec,c,tp)
	return ec:IsControler(1-tp) and ec:IsLevelBelow(6)
end
function s.filter(c)
	return c:IsLevelBelow(6) and c:IsFaceup() and c:IsAbleToChangeControler()
end
...
function s.spfilter(c,e,tp)
	return (c:IsCode(23756165) or (c:IsSetCard(0x41) and c:IsLevelBelow(3))) and c:IsCanBeSpecialSummoned(e,0,tp,true,true)
end
