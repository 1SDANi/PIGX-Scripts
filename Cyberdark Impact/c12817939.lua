...
function s.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if d and d:IsControler(tp) then d=Duel.GetAttacker() end
...
function s.spfilter(c,e,tp)
	return (c:IsCode(58206034) or (c:IsSetCard(0x41) and c:IsLevelBelow(6))) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
