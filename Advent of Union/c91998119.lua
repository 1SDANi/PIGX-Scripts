...
function s.initial_effect(c)
	--fusion material
	Fusion.AddProcMix(c,false,true,true,62651957,64500000,65622692)
...
function s.ctfilter(c,e,tp)
	return c:IsCode(62651957,64500000,65622692) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
