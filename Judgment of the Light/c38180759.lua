--虚構王アンフォームド・ボイド
--Unformed Void the Fictional King
local s,id=GetID()
...
function s.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetTurnPlayer()~=tp and Duel.IsExistingMatchingCard(Card.IsFaceup,tp,0,LOCATION_MZONE,1,nil) end
end
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk ==0 then	return t and ep~=tp and e:GetHandler():IsPosition(POS_ATTACK) end
