...
function s.cfilter(c)
	return c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c,true) and c:IsRace(RACE_MACHINE)
end
...
function s.fusionfilter(c,fc,sumtype,sp,sub,mg,sg)
	...
	return c:IsLevel(lv) and c:IsRace(RACE_MACHINE)
end
