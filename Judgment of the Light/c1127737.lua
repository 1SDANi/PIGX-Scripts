--異次元の古戦場－サルガッソ
--Ancient D.D. Battlefield Super Sargasso
local s,id=GetID()
...
function s.damcon1(e,tp,eg,ep,ev,re,r,rp)
	return eg:GetFirst():IsSummonType(SUMMON_TYPE_FUSION)
end
...
function s.damcon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsType,TYPE_FUSION),Duel.GetTurnPlayer(),LOCATION_MZONE,0,1,nil)
end
