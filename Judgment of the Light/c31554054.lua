...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return at and at:IsFaceup() and at:IsControler(tp) and at:IsType(TYPE_FUSION)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if at:IsRelateToEffect(e) and at:IsFaceup() and Duel.SendtoDeck(at,nil,2,REASON_EFFECT)>0 then
		...
		if tc:IsRelateToEffect(e) and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)~=0 and tc:IsCanAddCounter(COUNTER_XYZ,1) then
