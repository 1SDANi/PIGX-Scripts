...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local dg=Duel.GetMatchingGroup(Card.IsCode,tc:GetControler(),LOCATION_DECK+LOCATION_HAND+LOCATION_ONFIELD+LOCATION_EXTRA,LOCATION_DECK+LOCATION_HAND+LOCATION_ONFIELD+LOCATION_EXTRA,nil,tc:GetCode())
