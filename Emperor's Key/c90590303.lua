...
function s.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return not c:IsReason(REASON_REPLACE) and e:GetHandler():IsCanRemoveCounter(tp,COUNTER_XYZ,1,REASON_EFFECT) and Duel.IsExistingMatchingCard(s.repfilter,tp,0,LOCATION_MZONE,1,c,e) end
