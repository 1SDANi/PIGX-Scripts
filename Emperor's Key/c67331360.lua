...
function s.cfilter(c)
	return c:IsLocation(LOCATION_GRAVE) and c:IsReason(REASON_BATTLE+REASON_EFFECT) and c:IsLocation(LOCATION_GRAVE) and c:IsType(TYPE_NORMAL) and c:IsAttackBelow(0) and c:IsDefenseBelow(0)
end
