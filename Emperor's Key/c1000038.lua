...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.dfilter,tp,0,LOCATION_ONFIELD,1,nil) and e:GetHandler():GetEquipTarget() end
	local g=Duel.GetMatchingGroup(s.dfilter,tp,0,LOCATION_ONFIELD,nil)
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,g,#g,0,0)
	Duel.SetOperationInfo(0,CATEGORY_RECOVER,nil,0,1-tp,#g*2000)
end
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Damage(1-tp,#dg*2000,REASON_EFFECT)
end
