...
--Chaos Number 5: Chaos Chimera Dragon
local s,id=GetID()
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return tc:IsCanAddCounter(COUNTER_XYZ,1) end
...
function s.accn(e,tp,eg,ep,ev,re,r,rp)
	local ct=e:GetHandler():GetFlagEffect()
	return ct and ct>0
end
...
function s.chaosfilter(c,e,tp)
	return c:IsFaceup() and c:IsCanBeFusionMaterial() and c:IsCode(90126061)
end
