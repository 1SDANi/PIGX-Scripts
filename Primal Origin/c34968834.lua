...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if rp~=tp and tp==e:GetLabel() and Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_DECK,0,1,nil,e,tp) then
		Duel.BreakEffect()
