...
function s.cfilter(c,tp)
	return c:IsPreviousPosition(POS_FACEDOWN) and c:IsFaceup() and c:IsControler(tp) and c:IsType(TYPE_FUSION) and c:IsCanAddCounter(COUNTER_XYZ,1)
end
function s.cttg(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=eg:Filter(s.cfilter,e:GetHandler(),tp)
