...
function s.initial_effect(c)
	...
	e3:SetProperty(EFFECT_FLAG_SET_AVAILABLE+EFFECT_FLAG_BOTH_SIDE)
...
function s.cfilter(c,e,tp,rp)
	if c:IsFacedown() or not c:IsAttribute(ATTRIBUTE_DIVINE) or not c:IsAbleToGraveAsCost() then return false end
