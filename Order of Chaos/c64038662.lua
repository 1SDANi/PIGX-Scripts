...
function s.filter1(c)
	return c:IsFaceup() and c:IsSetCard(0x56) and c:IsType(TYPE_UNION)
end
function s.filter2(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x56) and c:IsType(TYPE_UNION) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
