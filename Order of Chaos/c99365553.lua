...
function s.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local rg=rg1:Clone()
	rg:Merge(rg2)
	if chk==0 then return #rg1>0 and #rg2>0 and aux.SelectUnselectGroup(rg,e,tp,2,2,s.rescon,0) and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,e:GetHandler()) end
