...
s.fit_monster={85346853}
function s.filter(c,e,tp,m)
	local cd=c:GetCode()
	if cd~=85346853 or not c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_RITUAL,tp,true,true) then return false end
