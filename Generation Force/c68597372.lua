...
s.listed_names={id}
function s.filter(c)
	return c:IsFaceup() and c:IsCanTurnSet() and not c:IsCode(id)
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) and tc:IsFaceup() and Duel.ChangePosition(tc,POS_FACEDOWN_DEFENSE) then
