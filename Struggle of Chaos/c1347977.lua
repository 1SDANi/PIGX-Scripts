...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsRace,RACE_WARRIOR),tp,LOCATION_MZONE,0,1,e:GetHandler())
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g2 and g2:GetFirst():IsRelateToEffect(e) and
		Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsRace,RACE_WARRIOR),tp,LOCATION_MZONE,0,1,e:GetHandler()) then
