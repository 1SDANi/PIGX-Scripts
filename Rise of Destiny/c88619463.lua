--黒の魔法神官
--Super Magical Spellcaster - Dark Hierophant
local s,id=GetID()
function s.initial_effect(c)
	--fusion material
	Fusion.AddProcMix(c,false,true,true,CARD_DARK_MAGICIAN,38033121)
	--negate
...
function s.filter(c)
	return c:IsRace(RACE_SPELLCATER) and (c:IsLocation(LOCATION_GRAVE) or c:IsFaceup())
end
