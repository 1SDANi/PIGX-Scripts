--CNo.65 裁断魔王ジャッジ・デビル
--Chaos Number 65: Devil Judge King
local s,id=GetID()
...
function s.disable(e,c)
	return c:IsType(TYPE_EFFECT) and c~=e:GetHandler() and Duel.GetFieldGroupCount(e:GetHandler():GetControler(),LOCATION_MZONE,0)==1
end
function s.chaosfilter(c,e,tp)
	return c:IsFaceup() and c:IsCanBeFusionMaterial() and c:IsCode(3790062)
end
