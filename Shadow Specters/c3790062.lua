...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return rp~=tp and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED) and re:IsActiveType(TYPE_MONSTER) end
