...
function s.fusionfilter(c,fc,sumtype,sp,sub,mg,sg)
	...
	return c:HasLevel() and (c:IsType(TYPE_FUSION) or c:IsCode(CARD_STARDUST_DRAGON)) and (not rg or not sg or (st==tg and #sg>1) or (st<tg and rg:CheckWithSumEqual(Card.GetLevel,tg-st,1,99)))
end
