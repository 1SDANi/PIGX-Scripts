...
function s.condition(c)
	return Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,5,e:GetHandler()) and
		Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_ONFIELD,0,2,e:GetHandler()) and
		Duel.IsExistingMatchingCard(s.filter,tp,0,LOCATION_ONFIELD,2,e:GetHandler())
end
