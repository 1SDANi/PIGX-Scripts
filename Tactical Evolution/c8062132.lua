...
function s.cfilter(c,ft,ct)
	return c:IsCode(72677437) and (ft>=ct or c:GetSequence()<5)
end
...
function s.atkval(e,c)
	return Duel.GetMatchingGroupCount(Card.IsRace,c:GetControler(),LOCATION_GRAVE,0,nil,RACE_REPTILE)*1000
end
