...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(Duel.IsType,1-p,LOCATION_HAND,0,1,nil,TYPE_SPELL) and Duel.IsPlayerCanDraw(1-p,2) and Duel.SelectYesNo(1-p,aux.Stringid(id,1)) and
