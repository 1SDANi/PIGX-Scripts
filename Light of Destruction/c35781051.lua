...
function s.initial_effect(c)
	...
	e4:SetCountLimit(1)
	e4:SetTarget(Auxiliary.ExtraNormalTarget{summon=true})
	e4:SetOperation(Auxiliary.ExtraNormalOperation{summon=true})
	c:RegisterEffect(e4)
	--special summon
	...
	e5:SetCountLimit(1)
	e5:SetCondition(s.specialcondition)
	e5:SetCost(s.cost)
...
s.toss_coin=true
function s.normalcondition(e)
	return e:GetHandler():GetFlagEffectLabel(36690018)==1
end
function s.specialcondition(e)
