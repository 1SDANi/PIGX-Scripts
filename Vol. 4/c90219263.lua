...
function s.filter(c,e,tp)
	return c:IsCode(CARD_HARPY_LADY) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.filter,tp,LOCATION_HAND+LOCATION_DECK,0,1,2,nil,e,tp)
	if #g>0 then
